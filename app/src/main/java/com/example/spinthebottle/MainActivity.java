                ...
                rotateBottle.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if(theSpinDegrees % 360 > 270 ) {
                            Toast.makeText(MainActivity.this, "The person to the top left has been chosen", Toast.LENGTH_LONG).show();
                        } else if (theSpinDegrees % 360 > 180) {
                            Toast.makeText(MainActivity.this, "The person to the bottom left has been chosen", Toast.LENGTH_LONG).show();
                        } else if (theSpinDegrees % 360 > 90) {
                            Toast.makeText(MainActivity.this, "The person to the bottom right has been chosen", Toast.LENGTH_LONG).show();
                        } else{
                            Toast.makeText(MainActivity.this, "The person to the top right has been chosen", Toast.LENGTH_LONG).show();
                        }
                    }
